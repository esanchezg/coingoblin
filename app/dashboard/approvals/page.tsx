    ...
    <div className="flex flex-col gap-6">
      ...
      {pending.length === 0 ? (
        ...
        <ul className="flex flex-col gap-3">
          {pending.map((item) => (
            <li key={item.id} className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900">
              ...
              <div className="mt-3 flex gap-2">
                ...
                >
                  <button
                    type="submit"
                    className="w-full rounded-xl bg-emerald-600 px-4 py-2 font-semibold text-white dark:bg-emerald-700"
                  >
                    Approve
                  </button>
                </form>
                ...
                >
                  <button
                    type="submit"
                    className="w-full rounded-xl border border-slate-300 px-4 py-2 font-semibold text-slate-600 dark:border-slate-700 dark:text-slate-300"
                  >
                    Reject
                  </button>
                </form>
